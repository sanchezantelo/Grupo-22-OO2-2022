...
public abstract class NotaPedidoModel {
	...
	public NotaPedidoModel(int id, LocalDate fecha, int cantEstudiantes, Set<Usuario> docentes, String observaciones,
	...
	public NotaPedidoModel(LocalDate fecha, int cantEstudiantes, Set<Usuario> docentes, String observaciones,
			String tipoAula, boolean asignada, Aula aulaAsignada, Usuario solicitante) {
		super();
		this.fecha = fecha;
		this.cantEstudiantes = cantEstudiantes;
